...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<activerecord>.freeze, ["= 5.0.7.2"])
      s.add_dependency(%q<actionmailer>.freeze, ["= 5.0.7.2"])
      s.add_dependency(%q<activejob>.freeze, ["= 5.0.7.2"])
      s.add_dependency(%q<actioncable>.freeze, ["= 5.0.7.2"])
      s.add_dependency(%q<railties>.freeze, ["= 5.0.7.2"])
