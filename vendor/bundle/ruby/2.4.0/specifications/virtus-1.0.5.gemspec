...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<descendants_tracker>.freeze, [">= 0.0.3", "~> 0.0"])
      s.add_runtime_dependency(%q<equalizer>.freeze, [">= 0.0.9", "~> 0.0"])
      s.add_runtime_dependency(%q<coercible>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<axiom-types>.freeze, ["~> 0.1"])
      s.add_development_dependency(%q<rake>.freeze, [">= 0"])
    else
      s.add_dependency(%q<descendants_tracker>.freeze, [">= 0.0.3", "~> 0.0"])
      s.add_dependency(%q<equalizer>.freeze, [">= 0.0.9", "~> 0.0"])
