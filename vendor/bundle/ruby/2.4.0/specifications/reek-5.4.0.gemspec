...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<parser>.freeze, ["!= 2.5.1.1", "< 2.7", ">= 2.5.0.0"])
      s.add_runtime_dependency(%q<psych>.freeze, ["~> 3.1.0"])
      s.add_runtime_dependency(%q<rainbow>.freeze, ["< 4.0", ">= 2.0"])
    else
      s.add_dependency(%q<codeclimate-engine-rb>.freeze, ["~> 0.4.0"])
      s.add_dependency(%q<kwalify>.freeze, ["~> 0.7.0"])
      s.add_dependency(%q<parser>.freeze, ["!= 2.5.1.1", "< 2.7", ">= 2.5.0.0"])
      s.add_dependency(%q<psych>.freeze, ["~> 3.1.0"])
      s.add_dependency(%q<rainbow>.freeze, ["< 4.0", ">= 2.0"])
    end
  else
    s.add_dependency(%q<codeclimate-engine-rb>.freeze, ["~> 0.4.0"])
    s.add_dependency(%q<kwalify>.freeze, ["~> 0.7.0"])
