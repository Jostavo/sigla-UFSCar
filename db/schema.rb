...
ActiveRecord::Schema.define(version: 20161209215103) do
  ...
  create_table "authorized_people", force: :cascade do |t|
    ...
    t.index ["laboratory_id"], name: "index_authorized_people_on_laboratory_id"
    t.index ["user_id"], name: "index_authorized_people_on_user_id"
  end
  ...
  create_table "biometric_accesses", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["laboratory_id"], name: "index_biometric_accesses_on_laboratory_id"
    t.index ["user_id"], name: "index_biometric_accesses_on_user_id"
  end
